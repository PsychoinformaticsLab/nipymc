...
pickle.dump(summary, open('/corral-repl/utexas/neurosynth/results/sc_results/sc_rand_r'+region+'_summary.pkl', 'wb'))
pickle.dump(fitted.trace, open('/corral-repl/utexas/neurosynth/results/sc_results/sc_rand_r'+region+'_trace.pkl', 'wb'))

# save PNG of traceplot
plt.figure()
pm.traceplot(fitted.trace[BURN:])
plt.savefig('/corral-repl/utexas/neurosynth/results/sc_results/sc_rand_r'+region+'.png')
