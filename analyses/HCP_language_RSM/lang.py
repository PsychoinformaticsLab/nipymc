...
pickle.dump(summary, open('/scratch/03754/jaw5629/lang_results_final/lang_rand_r'+region+'_summary.pkl', 'wb'))
pickle.dump(fitted.trace, open('/scratch/03754/jaw5629/lang_results_final/lang_rand_r'+region+'_trace.pkl', 'wb'))

# save PNG of traceplot
plt.figure()
pm.traceplot(fitted.trace[BURN:])
plt.savefig('/scratch/03754/jaw5629/lang_results_final/lang_rand_r'+region+'.png')
