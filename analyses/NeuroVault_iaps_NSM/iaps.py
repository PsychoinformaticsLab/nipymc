...
pickle.dump(summary, open('/scratch/03754/jaw5629/iaps_results/iaps_fix_r'+region+'_summary.pkl', 'wb'))
pickle.dump(trace, open('/scratch/03754/jaw5629/iaps_results/iaps_fix_r'+region+'_trace.pkl', 'wb'))

# save PNG of traceplot
plt.figure()
pm.traceplot(trace[BURN:])
plt.savefig('/scratch/03754/jaw5629/iaps_results/iaps_fix_r'+region+'.png')
